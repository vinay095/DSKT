...
export const INITIAL_FLOOR_PLAN: FloorPlan = {
  ...
  desks: [
    { id: 'desk-101', code: 'A-101', x: 3, y: 3, rotation: 0, status: 'occupied', assignedUserId: 'usr-4', assignedUserName: 'David Chen', department: 'Engineering', hasMonitor: true, isStandingDesk: true },
    { id: 'desk-102', code: 'A-102', x: 5, y: 3, rotation: 0, status: 'occupied', assignedUserId: 'usr-5', assignedUserName: 'Elena Rostova', department: 'Product', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-103', code: 'A-103', x: 7, y: 3, rotation: 0, status: 'occupied', assignedUserId: 'usr-6', assignedUserName: 'James Wilson', department: 'Design', hasMonitor: true, isStandingDesk: true },
    { id: 'desk-104', code: 'A-104', x: 3, y: 5, rotation: 0, status: 'occupied', assignedUserId: 'usr-1', assignedUserName: 'Alex Rivera', department: 'Engineering', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-105', code: 'A-105', x: 5, y: 5, rotation: 0, status: 'available', department: 'Engineering', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-106', code: 'A-106', x: 7, y: 5, rotation: 0, status: 'available', department: 'Engineering', hasMonitor: false, isStandingDesk: true },
    
    { id: 'desk-201', code: 'B-201', x: 12, y: 3, rotation: 0, status: 'occupied', assignedUserId: 'usr-2', assignedUserName: 'Sarah Jenkins', department: 'People & Culture', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-202', code: 'B-202', x: 14, y: 3, rotation: 0, status: 'available', department: 'Product', hasMonitor: true, isStandingDesk: true },
    { id: 'desk-203', code: 'B-203', x: 16, y: 3, rotation: 0, status: 'reserved', department: 'Product', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-204', code: 'B-204', x: 12, y: 5, rotation: 0, status: 'available', department: 'Product', hasMonitor: true, isStandingDesk: false },
    
    { id: 'desk-301', code: 'C-301', x: 3, y: 10, rotation: 0, status: 'occupied', assignedUserId: 'usr-3', assignedUserName: 'Marcus Vance', department: 'Facilities & Infrastructure', hasMonitor: true, isStandingDesk: true },
    { id: 'desk-302', code: 'C-302', x: 5, y: 10, rotation: 0, status: 'available', department: 'People & Culture', hasMonitor: true, isStandingDesk: false },
    { id: 'desk-303', code: 'C-303', x: 7, y: 10, rotation: 0, status: 'maintenance', department: 'Facilities', hasMonitor: false, isStandingDesk: false },
  ]
};
